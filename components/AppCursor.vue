...
onMounted(() => window.addEventListener('mousemove', (event: any) => {
...
onUnmounted(() => window.removeEventListener('mousemove', (event: MouseEvent) => updateCursor(event)))
</script>

<template>
  <div class="lg:block hidden">
    <div ref="cursorDot" :style="{ top: `${y}px`, left: `${x}px` }"
